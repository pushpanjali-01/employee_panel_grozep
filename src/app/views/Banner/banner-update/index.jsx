...
const BannerUpdate = () => {
    ...
    useEffect(() => {
        if (UpdatebannerData) {
            console.log(UpdatebannerData.isActive)
            ...
            if (
                UpdatebannerData.title ||
                UpdatebannerData.description ||
                UpdatebannerData.targetScreen
            ) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (formData.imageFile) {
            ...
            const extractedFilename = imageUrl
                ? imageUrl.split('/').pop()
                : null
        ...
        try {
            const response = await url.put(
                `v1/in/banners/${UpdatebannerData.id}`,
                payload
            )
                                ...
                                <div className="category">
                                    {targetScreen ? (
                                        ...
                                        >
                                            ...
                                            <option value="winter-sale-offer">
                                                Winter Sale
                                            </option>
                                        </select>
                                    )}
